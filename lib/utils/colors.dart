...
class XColors {
  ...
  static Color white() => getDarkMode != true ? const Color(0xFFFFFFFF) : const Color(0xFF000000);
  ...
  static Color textColor() => getDarkMode != true ? Colors.black87 : const Color(0xFFFFFFFF).withOpacity(0.9);
